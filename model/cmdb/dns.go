...
type DNS struct {
	...
	Hosts            datatypes.JSONSlice[string] `json:"hosts,omitempty" schema:"hosts"`
	ServerIps        datatypes.JSONSlice[string] `json:"server_ips,omitempty" schema:"server_ips"`
	SourceIps        datatypes.JSONSlice[string] `json:"source_ips,omitempty" schema:"source_ips"`
	PurchaseAt       datatypes.JSONSlice[string] `json:"purchase_at,omitempty" schema:"purchase_at"`
	PurchaseDuration time.Duration               `json:"purchase_duration,omitempty" schema:"purchase_duration"`
	ExpireAt         datatypes.JSONSlice[string] `json:"expire_at,omitempty" schema:"expire_at"`
	CdnProvider      string
	...
	Project      *setting.Project `json:"project,omitempty" gorm:"-"`
	SubProject   *setting.Project `json:"sub_project,omitempty" gorm:"-"`
