...
func Init() error {
	router.Register[*cmdb.DNS, *cmdb.DNS, *cmdb.DNS](router.API(), "dns", consts.List)
	router.Register[*cmdb.Machine, *cmdb.Machine, *cmdb.Machine](router.API(), "machine", consts.List)
